...
namespace Sitecore.Commerce.ServiceProxy
{
    ...
    public class Proxy
    {
        ...
        public static global::CommerceProxy.Sitecore.Commerce.EntityViews.EntityView GetEntityView(Container container, string entityId, string viewName, string forAction, string itemId)
        {
            var watch = new Stopwatch();
            watch.Start();
